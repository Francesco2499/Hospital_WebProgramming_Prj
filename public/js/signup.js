...
date.classList.add('errore');
    if (input.nome.value.length ===0 || input.cognome.value.length === 0 || input.email.value.length === 0 || input.birthdate.value.length === 0 || input.username.value.length === 0 || input.password.value.length === 0 || input.confirmpassword.value.length === 0) {
