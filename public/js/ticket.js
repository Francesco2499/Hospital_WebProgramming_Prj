...
/*function onjson(json){
    console.log(json);
        if(json===false){*/
    fetch("/HW2/public/recupero/dati/ticket").then(onResponse).then(onjson1);
...
const sec = document.createElement('div');
 ...
 sec.appendChild(h2);
    ...
    p.textContent="Nome: " + json.nome;
    sec.appendChild(p);
     p = document.createElement('p');
    p.textContent="Cognome: " + json.cognome;
    sec.appendChild(p);
 p = document.createElement('p');
    p.textContent="Cellulare: " + json.ticket.Cellulare;
    sec.appendChild(p);
  p = document.createElement('p');
    p.textContent="Codice Ticket: " + json.ticket.codTicket;
    sec.appendChild(p);
    p = document.createElement('p');
    const d = new Date(json.ticket.Data + " " + json.ticket.orario);
    console.log(json.ticket.Data + " " + json.ticket.orario);
    if(d.getHours()<10 && d.getMinutes()<10){
        console.log('1');
    p.textContent="Data e orario prenotazione: " + json.ticket.Data + "  0" + d.getHours() + ":0" + d.getMinutes();
    }else if(d.getHours()>=10 && d.getMinutes()<10){
        console.log('2');
        p.textContent="Data e orario prenotazione: " + json.ticket.Data + "  " + d.getHours() + ":0" + d.getMinutes();
    }else if (d.getHours()>=10 && d.getMinutes()>=10){
        console.log('3');
        p.textContent="Data e orario prenotazione: " + json.ticket.Data + "  " + d.getHours() + ":" + d.getMinutes();
    }else{
        console.log('4');
        p.textContent="Data e orario prenotazione: " + json.ticket.Data + "  0" + d.getHours() + ":" + d.getMinutes();
    }
    sec.appendChild(p);
    p = document.createElement('p');
    p.textContent="E-mail:  " + json.email;
    sec.appendChild(p);
...
const main=document.querySelector('main');
       ...
       fetch("/HW2/public/elimina/prenotazione").then(onResponse1);
}
