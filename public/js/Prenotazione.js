...
fetch("/HW2/public/recupero/dati/vaccinazione").then(onResponse).then(onJson1);
function onJson1(json){
    ...
    par.textContent='Nome: ' + json.nome;
    div.appendChild(par);
    const par1 = document.createElement('p');
    par1.textContent='Cognome: ' + json.cognome;
    div.appendChild(par1);
    const par2 = document.createElement('p');
    par2.textContent='Data di nascita: ' + json.data;
    div.appendChild(par2);
    const par3 = document.createElement('p');
    par3.textContent='E-mail: ' + json.email;
    div.appendChild(par3);
    const par4 = document.createElement('p');
    par4.textContent='Codice Fiscale: ' + json.vaccinazioni.CodiceFiscale.toUpperCase();
    div.appendChild(par4);
    const par5 = document.createElement('p');
    par5.textContent='Codice Prenotazione: ' + json.vaccinazioni.codprenotazione;
    div.appendChild(par5);
    const par6 = document.createElement('p');
    par6.textContent='Preferenza vaccino: ' + json.vaccinazioni.vaccino.vaccino;
...
fetch("/HW2/public/elimina/vaccino").then(onResponse1);
}
